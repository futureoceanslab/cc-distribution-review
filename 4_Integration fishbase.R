...
ReviewDatsp <-  subset(ReviewDatsp, select=c(id_obs, site, id_study, eez_countries, b_scientific_name, 
                                           cc, b_impact, b_value, SpecCode, duplications, b_value_original, 
